...
typedef Test1::OdomMeasurement<T> OMeas_;
typedef Test1::OdomMeasurementModel<T> OM_;

typedef Test1::LidarMeasurement<T> LMeas_;
typedef Test1::LidarMeasurementModel<T> LM_;
...
int main(int argc, char** argv) {
    ...
    Filter_predict_part<T, S_, C_, SM_, OMeas_, OM_, LMeas_, LM_, GMeas_, GM_, VMeas_, VM_ > filter_core(node);
